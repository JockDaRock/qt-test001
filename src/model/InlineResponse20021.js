...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TeamUsage'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TeamUsage'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse20021 = factory(root.PerchApi.ApiClient, root.PerchApi.TeamUsage);
  }
}(this, function(ApiClient, TeamUsage) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/TeamUsage>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [TeamUsage]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/TeamUsage>} results
   */
