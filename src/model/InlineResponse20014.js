...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/NetworkSubnet'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NetworkSubnet'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse20014 = factory(root.PerchApi.ApiClient, root.PerchApi.NetworkSubnet);
  }
}(this, function(ApiClient, NetworkSubnet) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/NetworkSubnet>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [NetworkSubnet]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/NetworkSubnet>} results
   */
