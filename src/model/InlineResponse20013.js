...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiIndicatorSerializer'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiIndicatorSerializer'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse20013 = factory(root.PerchApi.ApiClient, root.PerchApi.ApiIndicatorSerializer);
  }
}(this, function(ApiClient, ApiIndicatorSerializer) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/ApiIndicatorSerializer>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [ApiIndicatorSerializer]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/ApiIndicatorSerializer>} results
   */
