...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Blacklist'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Blacklist'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse20011 = factory(root.PerchApi.ApiClient, root.PerchApi.Blacklist);
  }
}(this, function(ApiClient, Blacklist) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/Blacklist>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [Blacklist]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Blacklist>} results
   */
