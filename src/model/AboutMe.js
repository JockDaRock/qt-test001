...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PerchApi.AboutMe = factory(root.PerchApi.ApiClient, root.PerchApi.Preference);
  }
}(this, function(ApiClient, Preference) {
  'use strict';

  /**
   * The AboutMe model module.
   * @module model/AboutMe
   * @version v1
   */

  /**
   * Constructs a new <code>AboutMe</code>.
   * @alias module:model/AboutMe
   * @class
  ...
  /**
   * Constructs a <code>AboutMe</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AboutMe} obj Optional instance to populate.
   * @return {module:model/AboutMe} The populated <code>AboutMe</code> instance.
   */
