...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SLA'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SLA'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse20018 = factory(root.PerchApi.ApiClient, root.PerchApi.SLA);
  }
}(this, function(ApiClient, SLA) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/SLA>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [SLA]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/SLA>} results
   */
