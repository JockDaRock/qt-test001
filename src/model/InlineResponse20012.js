...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/IndicatorComment'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./IndicatorComment'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse20012 = factory(root.PerchApi.ApiClient, root.PerchApi.IndicatorComment);
  }
}(this, function(ApiClient, IndicatorComment) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/IndicatorComment>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [IndicatorComment]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/IndicatorComment>} results
   */
