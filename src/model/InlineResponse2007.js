...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EventNotification'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EventNotification'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse2007 = factory(root.PerchApi.ApiClient, root.PerchApi.EventNotification);
  }
}(this, function(ApiClient, EventNotification) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/EventNotification>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [EventNotification]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/EventNotification>} results
   */
