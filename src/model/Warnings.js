...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PerchApi.Warnings = factory(root.PerchApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('onboarding_incomplete'))
        obj.onboardingIncomplete = ApiClient.convertToType(data['onboarding_incomplete'], 'String');
    }
    return obj;
  }

  /**
   * @member {String} onboardingIncomplete
   */
  exports.prototype.onboardingIncomplete = undefined;
