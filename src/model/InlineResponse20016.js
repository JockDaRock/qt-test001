...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MarketplacePolymorphic'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MarketplacePolymorphic'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse20016 = factory(root.PerchApi.ApiClient, root.PerchApi.MarketplacePolymorphic);
  }
}(this, function(ApiClient, MarketplacePolymorphic) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/MarketplacePolymorphic>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [MarketplacePolymorphic]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/MarketplacePolymorphic>} results
   */
