...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ScheduledReport'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ScheduledReport'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse2009 = factory(root.PerchApi.ApiClient, root.PerchApi.ScheduledReport);
  }
}(this, function(ApiClient, ScheduledReport) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/ScheduledReport>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [ScheduledReport]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/ScheduledReport>} results
   */
