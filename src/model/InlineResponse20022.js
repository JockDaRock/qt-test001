...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CommunityList'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CommunityList'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse20022 = factory(root.PerchApi.ApiClient, root.PerchApi.CommunityList);
  }
}(this, function(ApiClient, CommunityList) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/CommunityList>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [CommunityList]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/CommunityList>} results
   */
