...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TeamHealth'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TeamHealth'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse20020 = factory(root.PerchApi.ApiClient, root.PerchApi.TeamHealth);
  }
}(this, function(ApiClient, TeamHealth) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/TeamHealth>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [TeamHealth]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/TeamHealth>} results
   */
