...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SupportedDevice'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SupportedDevice'));
  } else {
    // Browser globals (root is window)
    if (!root.PerchApi) {
      root.PerchApi = {};
    }
    root.PerchApi.InlineResponse20019 = factory(root.PerchApi.ApiClient, root.PerchApi.SupportedDevice);
  }
}(this, function(ApiClient, SupportedDevice) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/SupportedDevice>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results'))
        obj.results = ApiClient.convertToType(data['results'], [SupportedDevice]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/SupportedDevice>} results
   */
