...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NetworkSubnet', function() {
      beforeEach(function() {
        instance = new PerchApi.NetworkSubnet();
      });

      it('should create an instance of NetworkSubnet', function() {
        // TODO: update the code to test NetworkSubnet
        expect(instance).to.be.a(PerchApi.NetworkSubnet);
      });
      ...
      it('should have the property monitored (base name: "monitored")', function() {
        // TODO: update the code to test the property monitored
        expect(instance).to.have.property('monitored');
        // expect(instance.monitored).to.be(expectedValueLiteral);
      });
