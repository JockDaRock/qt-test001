...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Observable', function() {
      beforeEach(function() {
        instance = new PerchApi.Observable();
      });

      it('should create an instance of Observable', function() {
        // TODO: update the code to test Observable
        expect(instance).to.be.a(PerchApi.Observable);
      });
