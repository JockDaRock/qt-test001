...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SLAWindowCreation', function() {
      beforeEach(function() {
        instance = new PerchApi.SLAWindowCreation();
      });

      it('should create an instance of SLAWindowCreation', function() {
        // TODO: update the code to test SLAWindowCreation
        expect(instance).to.be.a(PerchApi.SLAWindowCreation);
      });
