...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SensorCommand', function() {
      beforeEach(function() {
        instance = new PerchApi.SensorCommand();
      });

      it('should create an instance of SensorCommand', function() {
        // TODO: update the code to test SensorCommand
        expect(instance).to.be.a(PerchApi.SensorCommand);
      });
