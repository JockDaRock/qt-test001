...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamEnterpriseSSO', function() {
      beforeEach(function() {
        instance = new PerchApi.TeamEnterpriseSSO();
      });

      it('should create an instance of TeamEnterpriseSSO', function() {
        // TODO: update the code to test TeamEnterpriseSSO
        expect(instance).to.be.a(PerchApi.TeamEnterpriseSSO);
      });
