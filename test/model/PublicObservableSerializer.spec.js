...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicObservableSerializer', function() {
      beforeEach(function() {
        instance = new PerchApi.PublicObservableSerializer();
      });

      it('should create an instance of PublicObservableSerializer', function() {
        // TODO: update the code to test PublicObservableSerializer
        expect(instance).to.be.a(PerchApi.PublicObservableSerializer);
      });
      ...
      it('should have the property observableId (base name: "observable_id")', function() {
