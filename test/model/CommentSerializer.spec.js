...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CommentSerializer', function() {
      beforeEach(function() {
        instance = new PerchApi.CommentSerializer();
      });

      it('should create an instance of CommentSerializer', function() {
        // TODO: update the code to test CommentSerializer
        expect(instance).to.be.a(PerchApi.CommentSerializer);
      });
