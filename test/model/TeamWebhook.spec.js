...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamWebhook', function() {
      beforeEach(function() {
        instance = new PerchApi.TeamWebhook();
      });

      it('should create an instance of TeamWebhook', function() {
        // TODO: update the code to test TeamWebhook
        expect(instance).to.be.a(PerchApi.TeamWebhook);
      });
