...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SensorCommandResult', function() {
      beforeEach(function() {
        instance = new PerchApi.SensorCommandResult();
      });

      it('should create an instance of SensorCommandResult', function() {
        // TODO: update the code to test SensorCommandResult
        expect(instance).to.be.a(PerchApi.SensorCommandResult);
      });
