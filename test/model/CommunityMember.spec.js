...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CommunityMember', function() {
      beforeEach(function() {
        instance = new PerchApi.CommunityMember();
      });

      it('should create an instance of CommunityMember', function() {
        // TODO: update the code to test CommunityMember
        expect(instance).to.be.a(PerchApi.CommunityMember);
      });
