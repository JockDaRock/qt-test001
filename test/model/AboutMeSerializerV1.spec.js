...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AboutMeSerializerV1', function() {
      beforeEach(function() {
        instance = new PerchApi.AboutMeSerializerV1();
      });

      it('should create an instance of AboutMeSerializerV1', function() {
        // TODO: update the code to test AboutMeSerializerV1
        expect(instance).to.be.a(PerchApi.AboutMeSerializerV1);
      });
