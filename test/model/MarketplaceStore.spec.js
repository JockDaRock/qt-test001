...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarketplaceStore', function() {
      beforeEach(function() {
        instance = new PerchApi.MarketplaceStore();
      });

      it('should create an instance of MarketplaceStore', function() {
        // TODO: update the code to test MarketplaceStore
        expect(instance).to.be.a(PerchApi.MarketplaceStore);
      });
