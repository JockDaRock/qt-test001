...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MarketplaceSourceCollection', function() {
      beforeEach(function() {
        instance = new PerchApi.MarketplaceSourceCollection();
      });

      it('should create an instance of MarketplaceSourceCollection', function() {
        // TODO: update the code to test MarketplaceSourceCollection
        expect(instance).to.be.a(PerchApi.MarketplaceSourceCollection);
      });
