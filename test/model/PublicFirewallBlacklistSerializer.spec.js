...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicFirewallBlacklistSerializer', function() {
      beforeEach(function() {
        instance = new PerchApi.PublicFirewallBlacklistSerializer();
      });

      it('should create an instance of PublicFirewallBlacklistSerializer', function() {
        // TODO: update the code to test PublicFirewallBlacklistSerializer
        expect(instance).to.be.a(PerchApi.PublicFirewallBlacklistSerializer);
      });
